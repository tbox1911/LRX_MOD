LRX_mod_list_name = [
	...
	["IC_AFMC","CSLA Armed Forces of the Midland Coalition"],
	["IC_CSLA","CSLA Czechoslovak People's Army"],
	["IC_US85","CSLA US Army"],
