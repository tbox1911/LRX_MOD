...
WRHS_Man = "AC_BLK_O_Survivor_Winter";					// Man in Warehouse
commander_classname = "AC_BLK_O_Rifleman_Unarmed_Winter";		// Sell-Man in FOB
...
infantry_units_west = [
	...
	["AC_BLK_O_Rifleman_Winter",1,0,0,0],
	["AC_BLK_O_Medic_Winter",1,0,0,0],
	["AC_BLK_O_Engineer_Winter",1,0,0,0],
	["AC_BLK_O_Grenadier_Winter",1,0,0,GRLIB_perm_inf],
	["AC_BLK_O_Marksman_Winter",1,0,0,GRLIB_perm_inf],
	["AC_BLK_O_Soldier_EXP_Winter",1,0,0,GRLIB_perm_inf],
	["AC_BLK_O_Soldier_MG_Winter",1,0,0,GRLIB_perm_inf],
	["AC_BLK_O_Rifleman_AT_Winter",1,0,0,GRLIB_perm_inf],
	["AC_BLK_O_Soldier_AA_Winter",1,0,0,GRLIB_perm_log],
