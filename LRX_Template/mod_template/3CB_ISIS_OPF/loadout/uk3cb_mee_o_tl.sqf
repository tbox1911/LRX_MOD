...
private _primary = selectRandomWeighted _primaryWeaponLeader;
...
// Remove if no GP Launcher
for "_i" from 1 to 4 do { 
	_unit addMagazine (selectRandom ["rhs_VOG25", "rhs_VOG25P"]); 
};
for "_i" from 1 to 2 do { 
	_unit addMagazine (selectRandom ["rhs_GRD40_white", "rhs_GRD40_red"]); 
};
