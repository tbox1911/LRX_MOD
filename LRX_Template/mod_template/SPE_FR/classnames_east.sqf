...
opfor_crew = "SPE_FR_Driver_Lite";
opfor_sentry = "SPE_FR_Rifleman";
opfor_rifleman = "SPE_FR_Assist_SquadLead";
opfor_grenadier = "SPE_FR_Grenadier";
opfor_squad_leader = "SPE_FR_SquadLead";
opfor_team_leader = "SPE_FR_Second_Lieutenant";
opfor_marksman = "SPE_FR_Flamethrower_Operator";
opfor_machinegunner = "SPE_FR_HMGunner";
opfor_heavygunner = "SPE_FR_Autorifleman";
opfor_medic = "SPE_FR_Medic";
opfor_rpg = "SPE_FR_AT_Soldier";
opfor_at = "SPE_FR_AT_Soldier";
opfor_aa = "SPE_FR_Autorifleman";
opfor_officer = "SPE_FR_Captain";
opfor_sharpshooter = "SPE_FR_Sniper";
...
opfor_transport_truck = "SPE_FR_M3_Halftrack_Unarmed";
opfor_fuel_truck = "SPE_FR_M3_Halftrack_Fuel";
...
opfor_recyclable = [
	...
	//
	["SPE_FR_M16_Halftrack",2,round (40 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Ambulance",2,round (50 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Ammo",2,round (60 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Repair",4,round (150 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Fuel",2,round (25 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Unarmed",2,round (35 / GRLIB_recycling_percentage),4],
	["SPE_FR_M3_Halftrack_Unarmed_Open",2,round (60 / GRLIB_recycling_percentage),4],
