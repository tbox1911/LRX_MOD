...
"cwr3_b_ranger_mg",
"cwr3_b_ranger_gl",
"cwr3_b_ranger_sapper",
"cwr3_b_ranger_engineer",
"cwr3_b_ranger_ar",
"cwr3_b_ranger_at_m67",
"cwr3_b_ranger_at_carlgustaf",
...
air_vehicles = [
	...
	["cwr3_b_camel",5,600,10,GRLIB_perm_air],
...
// Mod CLV AIR VEHICLES
if (isClass(configFile >> "CfgPatches" >> "I_MirageIIIEA_F")) then 
{
  air_vehicles pushBack ["I_F86_F",8,800,10,GRLIB_perm_tank];
  air_vehicles pushBack ["I_F5_F",8,1000,10,GRLIB_perm_tank];
  air_vehicles pushBack ["I_A4Skyhawk_F",8,1100,10,GRLIB_perm_tank];
};
...
static_vehicles = [
	["cwr3_b_searchlight",1,100,0,GRLIB_perm_log],
	["cwr3_b_m2hb_high",1,150,0,GRLIB_perm_log],
	["cwr3_b_m2hb_low",0,150,0,GRLIB_perm_log],
	["cwr3_b_mk19",1,150,0,GRLIB_perm_log],
	["cwr3_b_tow",1,200,0,GRLIB_perm_log],
	["cwr3_b_m119",0,500,0,GRLIB_perm_max],
	["cwr3_b_m252",0,350,0,GRLIB_perm_tank]
];
