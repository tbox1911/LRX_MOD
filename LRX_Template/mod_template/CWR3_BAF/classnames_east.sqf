...
opfor_sentry = "cwr3_b_uk_soldier";
opfor_rifleman = "cwr3_b_uk_soldier";
opfor_grenadier = "cwr3_b_uk_soldier_at_law";
opfor_squad_leader = "cwr3_b_uk_soldier_sl";
opfor_team_leader = "cwr3_b_uk_soldier_tl";
opfor_marksman = "cwr3_b_uk_soldier_marksman";
opfor_machinegunner = "cwr3_b_uk_soldier_mg";
opfor_heavygunner = "cwr3_b_uk_soldier_ar";
opfor_medic = "cwr3_b_uk_soldier_medic";
opfor_rpg = "cwr3_b_uk_soldier_at_law";
opfor_at = "cwr3_b_uk_soldier_at_carlgustaf";
opfor_aa = "cwr3_b_uk_soldier_aa_javelin";
opfor_officer = "cwr3_b_uk_officer";
opfor_sharpshooter = "cwr3_b_uk_soldier_sniper";
opfor_sniper = "cwr3_b_uk_soldier_sniper";
opfor_spotter = "cwr3_b_uk_soldier_spotter";
opfor_pilot = "cwr3_b_uk_soldier_pilot";
opfor_crew = "cwr3_b_uk_soldier_crewman";
opfor_engineer = "cwr3_b_uk_soldier_sapper";
opfor_paratrooper = "cwr3_b_uk_soldier_sas";
opfor_mrap = "cwr3_b_uk_landrover";
opfor_mrap_armed = "CUP_B_LR_Special_M2_GB_W";
opfor_mrap_hmg = "CUP_B_LR_Special_M2_GB_W";
opfor_mrap_gmg = "CUP_B_LR_Special_GMG_GB_W";
opfor_transport_helo = "cwr3_b_uk_puma_hc1";
opfor_transport_truck = "CUP_B_MTVR_BAF_WOOD";
opfor_fuel_truck = "cwr3_b_uk_fv620_refuel";
opfor_ammo_truck = "cwr3_b_uk_fv620_reammo";
opfor_fuel_container = "Land_Pod_Heli_Transport_04_fuel_F";
opfor_ammo_container = "Land_Pod_Heli_Transport_04_ammo_F";
opfor_flag = "cwr3_Flag_UnitedKingdom";
