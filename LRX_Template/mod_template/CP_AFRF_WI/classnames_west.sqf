...
// Armed Forces of the Russion Federation - Men (Ratnik-Winter). Requ. CUP Vehicles, CUP Units, CUP Weapons
...
crewman_classname = "CUP_O_RU_Soldier_Lite_Ratnik_Winter";
...
infantry_units_west = [
	...
	["CUP_O_RU_Soldier_Ratnik_Winter",1,0,0,0],
	["CUP_O_RU_Soldier_Medic_Ratnik_Winter",1,0,0,0],
	["CUP_O_RU_Soldier_Engineer_Ratnik_Winter",1,0,0,0],
	["CUP_O_RU_Soldier_Repair_Ratnik_Winter",1,0,0,0],
	["CUP_O_RU_Recon_Marksman_Ratnik_Winter",1,0,0,GRLIB_perm_inf],
	["CUP_O_RU_Soldier_Marksman_Ratnik_Winter",1,0,0,GRLIB_perm_inf],
	["CUP_O_RU_Soldier_AR_Ratnik_Winter",1,0,0,GRLIB_perm_inf],
	["CUP_O_RU_Soldier_MG_Ratnik_Winter",1,0,0,GRLIB_perm_inf],
	["CUP_O_RU_Soldier_AT_Ratnik_Winter",1,0,0,GRLIB_perm_log],
	["CUP_O_RU_Soldier_HAT_Ratnik_Winter",1,0,0,GRLIB_perm_log],
	["CUP_O_RU_Soldier_AA_Ratnik_Winter",1,0,0,GRLIB_perm_log],
...
heavy_vehicles = [
	...
	["CUP_O_MTLB_pk_Winter_RU",10,1250,10,GRLIB_perm_tank],
	["CUP_O_BRDM2_ATGM_RUS",10,1250,10,GRLIB_perm_tank],
	["CUP_O_BTR80_WINTER_RU",15,1500,15,GRLIB_perm_tank],
	["CUP_O_BTR80A_WINTER_RU",15,1700,15,GRLIB_perm_tank],
...
"CUP_O_Kamaz_Reammo_RU","Land_Pod_Heli_Transport_04_repair_F"
];

// Everything the AI troups should be able to healing from
ai_healing_sources_west = [
"O_Truck_03_medical_F","Land_Pod_Heli_Transport_04_medevac_F"
];
